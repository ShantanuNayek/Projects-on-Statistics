...
datat2=data.frame(0:20,Actual=ACTUAL_prob,Fitted=fit_POISSON_MLE)
data2=pivot_longer(data2,-1,"Index",values_to="v")
data2
ggplot(data2,aes(X0.20,v,fill=Index))+
...
data3=data.frame(0:20,Actual=ACTUAL_prob,Fitted=fit_ZIP_MLE)
data3=pivot_longer(data3,-1,"Index",values_to="v")
data3
ggplot(data3,aes(X0.20,v,fill=Index))+
  geom_bar(position="dodge",stat="identity")+
...
data4=data.frame(0:20,Actual=ACTUAL_prob,Fitted=fit_ZIP_MME)
data4=pivot_longer(data4,-1,"Index",values_to="v")
data4
ggplot(data4,aes(X0.20,v,fill=Index))+
  geom_bar(position="dodge",stat="identity")+
  labs(title="Fitting of ZIP Distribution",
